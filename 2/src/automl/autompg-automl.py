...
def main():
    f = open("/home/lazafi/labor/ml-2019/male2019/2/data/auto/autompg_clean.csv")
 ...
 #       per_run_time_limit=10,
        tmp_folder='/tmp/autosklearn_autompg1_tmp',
        output_folder='/tmp/autosklearn_autompg1_out',
        n_jobs=4,
        seed=5,
 #       exclude_estimators='DUMMY',
    ...
    print("start fitting")
    automl.fit(X_train, y_train, dataset_name='autompg', feat_type=feature_types, metric=rmse_scorer)
    print("end fittin")
